    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-2xl font-bold bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent">DevPost AI</span>
                <p className="text-xs text-gray-500 font-medium">LinkedIn Content Engine</p>
              </div>
            </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
        ...
        <div className="relative text-center space-y-10">
          {/* Badge */}
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-primary-50 to-indigo-50 text-primary-700 px-5 py-3 rounded-full text-sm font-semibold border-2 border-primary-200 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 pt-6">
            <Link
              to="/register"
              className="group px-10 py-5 bg-gradient-to-r from-primary-600 to-primary-700 text-white rounded-2xl font-bold text-xl hover:shadow-2xl hover:scale-110 transition-all duration-300 flex items-center space-x-3 shadow-xl"
            >
            ...
            <Link
              to="/about"
              className="px-10 py-5 bg-white text-gray-800 rounded-2xl font-bold text-xl border-3 border-gray-300 hover:border-primary-600 hover:text-primary-600 hover:shadow-xl transition-all duration-300"
            >
              Watch Demo
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 pt-20 max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-gray-100">
              <div className="text-5xl font-extrabold bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent">10x</div>
              <div className="text-gray-700 mt-3 font-semibold text-lg">Faster Content Creation</div>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-gray-100">
              <div className="text-5xl font-extrabold bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent">95%</div>
              <div className="text-gray-700 mt-3 font-semibold text-lg">Time Saved Weekly</div>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 border border-gray-100">
              <div className="text-5xl font-extrabold bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent">24/7</div>
              <div className="text-gray-700 mt-3 font-semibold text-lg">Content Ready</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-24 bg-gradient-to-b from-white via-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
            <div className="group bg-white rounded-3xl p-10 border-2 border-gray-200 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:border-primary-300">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">No Time to Post</h3>
            ...
            <div className="group bg-white rounded-3xl p-10 border-2 border-gray-200 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:border-primary-300">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Falling Behind</h3>
              <p className="text-gray-600 text-lg leading-relaxed">
            ...
            <div className="group bg-white rounded-3xl p-10 border-2 border-gray-200 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 hover:border-primary-300">
              ...
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Writer's Block</h3>
              <p className="text-gray-600 text-lg leading-relaxed">
      ...
      {/* CTA Section */}
      <div className="relative bg-indigo-700 py-28 overflow-hidden">
        {/* Decorative Elements */}
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-2xl text-white/90 mb-10 font-medium max-w-3xl mx-auto">
            Join thousands of professionals who are staying consistent and growing their presence effortlessly
          </p>
          <Link
            to="/register"
            className="inline-flex items-center space-x-3 px-12 py-6 bg-white text-primary-700 rounded-2xl font-bold text-xl hover:shadow-2xl hover:scale-110 transition-all duration-300 shadow-2xl group"
          >
            <span>Get Started Free</span>
            <ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition-transform duration-300" />
          </Link>
          <p className="text-white/80 mt-6 text-lg font-semibold">No credit card required • Start creating in minutes • Cancel anytime</p>
        </div>
      </div>

      {/* Footer */}
      <footer className="bg-white border-t border-gray-100 text-gray-600 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
